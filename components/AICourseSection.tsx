...
export default function AICoursePage() {
  ...
  // ⭐ The 5 Core Pillars of the Syllabus
  const coursePillars = [
    {
      id: 'understand',
      number: '१',
      ...
      descMr:
        'AI चे मूलभूत स्वरूप समजून घेणे, बाजारातील शेकडो टूल्समधून गोंधळून न जाता आपल्या कामासाठी अचूक टूल निवडण्याची हातोटी.',
      descHi:
        'AI की बुनियादी कार्यप्रणाली को समझना और बिना भटके अपने काम के लिए सबसे सटीक AI टूल चुनना।',
      steps: [
    ...
    },
    {
      ...
      descMr:
        'AI ला अचूक आज्ञा (Prompts) देण्याची कला. मराठी किंवा इंग्रजीत थेट मानवाप्रमाणे बोलणे आणि फॉलो-अप प्रॉम्प्ट्सने १००% अचूक काम करून घेणे.',
      descHi:
        'AI को सटीक निर्देश देने की कला। हिंदी-मराठी में संवाद और फॉलो-अप प्रॉम्प्ट्स से मनचाहा परिणाम पाना।',
      steps: [
    ...
    },
    {
      ...
      descMr:
        'ऑफिस व व्यवसायाचे तासन्‌तासांचे काम मिनिटांत: अचूक ईमेल, अवघड PDF चा सारांश, Word ड्राफ्टिंग, Excel फॉर्म्युला, PPT आणि सखोल अहवाल.',
      descHi:
        'दफ्तर और बिजनेस के घंटों का काम मिनटों में: ईमेल, PDF समरी, Word डॉक्यूमेंट्स, Excel फॉर्मूला और प्रेजेंटेशन।',
      steps: [
        { labelMr: 'Email & Letters', labelHi: 'ईमेल व लेटर्स' },
    ...
    },
    {
      ...
      descMr:
        'क्रिएटिव्ह डिझाईनची जादू: आकर्षक सणांचे/ऑफर्सचे पोस्टर्स, सोशल मीडिया पोस्ट्स, रील्स व्हिडिओ आणि अस्सल आवाजातील व्हॉईस-ओव्हर.',
      descHi:
        'रचनात्मक डिजाइन की दुनिया: पोस्टर्स, सोशल मीडिया पोस्ट्स, रील्स वीडियो और नेचुरल वॉइस-ओवर।',
      steps: [
        { labelMr: 'Images & Posters', labelHi: 'इमेज व पोस्टर्स' },
        { labelMr: 'Social Media', labelHi: 'सोशल मीडिया पोस्ट्स' },
        { labelMr: 'Video & Voice', labelHi: 'वीडियो व वॉइस' },
      ],
    ...
    },
    {
      ...
      descMr:
        'वारंवार कराव्या लागणाऱ्या कामांचे ऑटोमेशन: नो-कोड वर्कफ्लो, AI बॉट्सची ओळख आणि भविष्यातील AI तंत्रज्ञानासाठी स्वतःला सज्ज करणे.',
      descHi:
        'वर्कफ्लो ऑटोमेशन: बेसिक AI वर्कफ्लो सेट करना, AI एजेंट्स की पहचान और AI के भविष्य के लिए पूरी तैयारी।',
      steps: [
        { labelMr: 'Basic Workflows', labelHi: 'बेसिक वर्कफ्लो' },
        { labelMr: 'AI Agents ची ओळख', labelHi: 'AI एजेंट्स' },
        { labelMr: 'Future of AI', labelHi: 'भविष्य की तैयारी' },
      ],
  ...
  // 🛠️ The 10–12 Core Tools (No Confusion Philosophy)
  const coreToolsList = [
    {
      name: 'ChatGPT',
    ...
    {
      name: 'Claude',
      primaryUseMr: 'Documents, writing, deep analysis (लांबलचक मजकूर विश्लेषण)',
    ...
    {
      name: 'Gamma',
      primaryUseMr: 'AI presentations (फक्त एका प्रॉम्प्टवर संपूर्ण PPT डेक व वेबपेज तयार)',
    ...
    {
      name: 'Google Lens',
      primaryUseMr: 'Image/document information (कागदावरील मजकूर भाषांतर व त्वरित कॉपी)',
      primaryUseHi: 'Image/document information (फोटो से टेक्स्ट कॉपी व अनुवाद)',
  ...
  // 🎯 Real-Life Challenges by Profession (Capstone Project in Final Class)
  const realLifeChallenges = [
    {
      ...
      outcomeMr:
        'शिक्षकांचे ५ तासांचे तयारीचे काम फक्त १५ मिनिटांत! संपूर्ण धड्यावर आधारित परिपूर्ण मराठी शैक्षणिक साहित्य तयार होते.',
      outcomeHi:
        'अध्यापकों के 5 घंटे की तैयारी सिर्फ 15 मिनट में! पूरे पाठ पर आधारित तैयार शिक्षण सामग्री।',
      sampleInput: 'इयत्ता ७ वी विज्ञान: वनस्पतींमधील पोषण (Nutrition in Plants)',
      samplePrompt:
        'मी इयत्ता ७ वी चा विज्ञान शिक्षक आहे. "वनस्पतींमधील पोषण" या धड्यावर आधारित ४५ मिनिटांचा मराठी लेसन प्लान तयार कर. सोबत विद्यार्थ्यांना विचारण्यासाठी ५ सोपे व ५ विचार करायला लावणारे MCQ प्रश्न आणि उत्तरपत्रिका तयार कर.',
    },
    {
      id: 'business',
      ...
      outcomeMr:
        'महागड्या एजन्सीची गरज नाही! स्वतःच्या दुकानासाठी किंवा सर्व्हिससाठी सणांची जाहिरात, बॅनर व WhatsApp मेसेज काही मिनिटांत तयार.',
      outcomeHi:
        'बिना किसी एजेंसी के अपने बिजनेस के लिए फेस्टिवल ऑफर्स, पोस्टर और ऑटोमैटिक WhatsApp जवाब बनाएं।',
      sampleInput: 'पुण्यातील कपड्यांचे दुकान / सणासुदीची विशेष १०% सवलत',
      samplePrompt:
        'माझे पुण्यात साड्यांचे दुकान आहे. येणाऱ्या सणासाठी ग्राहकांना आकर्षित करणारा एक भावनिक आणि प्रभावी मराठी WhatsApp ऑफर मेसेज तयार कर, ज्यात १०% सूट आणि पत्ता नमूद असेल.',
    },
    {
      id: 'professional',
      ...
      outcomeMr:
        'ऑफिसमध्ये वेळेवर काम पूर्ण करून बॉस व मॅनेजमेंटवर छाप पाडा. अवघड Excel फॉर्म्युले व प्रेझेंटेशन अगदी सहज!',
      outcomeHi:
        'दफ्तर में घंटों का काम मिनटों में पूरा करें। कठिन Excel सूत्र और रिपोर्ट समरी सेकंड्स में तैयार।',
      sampleInput: 'तिमाही विक्री डेटा व क्लायंट फॉलो-अप ईमेल',
      samplePrompt:
        'आमच्या क्लायंटने पेमेंट उशिरा केले आहे. त्यांना नम्र परंतु ठामपणे आठवण करून देणारा एक औपचारिक कॉर्पोरेट ईमेल तयार कर, ज्यात प्रोजेक्ट डेडलाइनचा उल्लेख असेल.',
    },
    {
      id: 'parent',
      ...
      outcomeMr:
        'मुलांना ट्यूशनची गरज न भासता घरच्या घरी खेळता खेळता अभ्यास करून घेण्याचा नवा मार्ग! पालक व मुले दोघांचाही तणाव दूर.',
      outcomeHi:
        'बच्चों की पढ़ाई में बिना किसी तनाव के मदद करें। बोरिंग विषयों को मजेदार कहानियों और क्विज में बदलें।',
      sampleInput: '८ वर्षांच्या मुलासाठी इतिहास व गणिताचा मनोरंजक अभ्यास',
      samplePrompt:
        'माझ्या ८ वर्षांच्या मुलाला छत्रपती शिवाजी महाराजांचा इतिहास सोप्या गोष्टीच्या रूपात सांगा आणि त्यावर आधारित ३ मनोरंजक प्रश्न तयार करा जेणेकरून त्याला ते लक्षात राहील.',
    },
    {
      id: 'govt',
      ...
      outcomeMr:
        'शेकडो पानांचे शासकीय परिपत्रके व नियम काही सेकंदात समजून घेऊन अचूक शासकीय मराठीत परिपत्रके व टीपणी (Noting) तयार करा.',
      outcomeHi:
        'लंबे सरकारी दस्तावेजों का त्वरित सार समझें और नियमानुसार शुद्ध भाषा में आधिकारिक पत्र व रिपोर्ट तैयार करें।',
      sampleInput: 'नवीन शासन निर्णय (GR) चा सारांश व नागरिकांसाठी नोटीस',
      samplePrompt:
        'नवीन पाणीपुरवठा योजनेविषयी नागरिकांना माहिती देण्यासाठी शासकीय शिष्टाचाराला धरून एक स्पष्ट व नम्र मराठी जाहीर सूचना पत्रक तयार कर.',
    },
    {
      id: 'freelancer',
      ...
      outcomeMr:
        'आंतरराष्ट्रीय व स्थानिक क्लायंट्ससाठी प्रोफेशनल प्रपोजल्स व कोटेशन बनवून दुप्पट दराने काम मिळवण्याची क्षमता.',
      outcomeHi:
        'क्लाइंट्स को प्रभावित करने वाले प्रपोजल और कोटेशन मिनटों में तैयार कर अपनी कमाई और क्लाइंट बेस बढ़ाएं।',
      sampleInput: 'वेबसाईट रीडिझाईन व सोशल मीडिया मॅनेजमेंट प्रपोजल',
      samplePrompt:
        'एका रेस्टॉरंटच्या डिजिटल मार्केटिंगसाठी ₹२५,००० प्रति महिना या दराने एक प्रभावी आणि व्यावसायिक क्लायंट प्रपोजल ड्राफ्ट कर, ज्यात सेवांची यादी व फायदे असतील.',
    },
    {
      id: 'entrepreneur',
      ...
      outcomeMr:
        'नवीन व्यवसाय सुरू करताना होणारा लाखो रुपयांचा खर्च वाचवा; बाजारातील स्पर्धा, किंमत धोरण व ग्रोथ प्लॅन AI कडून तपासा.',
      outcomeHi:
        'नया बिजनेस शुरू करने के लिए संपूर्ण मार्केट रिसर्च, प्रतियोगी विश्लेषण और 90 दिनों का ग्रोथ रोडमैप हासिल करें।',
      sampleInput: 'पुण्यात सेंद्रिय अन्नधान्य (Organic Store) ची सुरुवात',
      samplePrompt:
        'पुण्यात सेंद्रिय भाजीपाला व किराणा सुरू करण्यासाठी एक प्राथमिक बिझनेस प्लॅन तयार कर. ग्राहकांची गरज, संभाव्य अडथळे आणि पहिल्या ३ महिन्यांचे मार्केटिंग बजेट स्पष्ट कर.',
    },
    {
      id: 'general40',
      ...
      outcomeMr:
        'तंत्रज्ञानाची कोणतीही भीती न बाळगता मोबाईलवर बोलून आरोग्य, प्रवास, बँकिंग व कौटुंबिक नियोजन स्वतःच्या हाताने आत्मविश्वासाने करा.',
      outcomeHi:
        'बिना किसी तकनीकी डर के आवाज से बात करके स्वास्थ्य, यात्रा और दैनिक कार्यों की पूरी जानकारी प्राप्त करें।',
      sampleInput: 'ज्येष्ठ नागरिकांसाठी अष्टविनायक यात्रा नियोजन व आरोग्य काळजी',
      samplePrompt:
        'पुण्याहून ज्येष्ठ नागरिकांसाठी ३ दिवसांच्या अष्टविनायक यात्रेचे आरामदायी नियोजन तयार करा, ज्यात प्रवासातील अंतर, विश्रांतीची ठिकाणे आणि घ्यावयाची काळजी स्पष्ट असेल.',
    },
  ];
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 pb-6 border-b border-stone-100">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-2xl bg-[#581825] text-amber-300 flex items-center justify-center shadow-inner">
                <currentChallenge.icon className="w-6 h-6" />
              </div>
              <div>
            ...
            <div className="lg:col-span-6 space-y-6">
              ...
              <div className="bg-white/10 rounded-2xl p-5 border border-white/15">
                <div className="flex items-baseline gap-3">
                  <span className="text-3xl sm:text-4xl font-extrabold text-amber-300">₹१,४९९/-</span>
                  <span className="text-lg text-stone-300 line-through">₹४,९९९/-</span>
                  <span className="px-2 py-0.5 rounded bg-emerald-500 text-white font-bold text-xs">
                    ७०% सवलत (Early Bird)
                  </span>
                </div>
                <p className="text-xs text-stone-300 mt-2">
                  *आगामी रविवार बॅचमध्ये फक्त २५ जागा उपलब्ध आहेत. टोकन रक्कम भरून सीट आरक्षित करा.
                </p>
              </div>
